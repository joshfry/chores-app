            ...
            >
              ...
              <div className="flex gap-2 w-full mt-auto">
                <button
                  ...
                  className="flex-1 px-3 py-1.5 text-xs border border-blue-600 text-blue-600 rounded-md hover:bg-blue-50 transition-colors"
                ...
                <button
                  ...
                  className="flex-1 px-3 py-1.5 text-xs border border-red-600 text-red-600 rounded-md hover:bg-red-50 transition-colors"
